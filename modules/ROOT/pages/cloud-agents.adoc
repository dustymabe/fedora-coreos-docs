...
https://fedoraproject.org/en/coreos/[Fedora CoreOS] has a lot of
...
But also like cloud-init, there is also significant overlap between a container-focused model of
the world and an Ignition-focused model.

Nevertheless, they don't actively conflict, and it is very likely
that e.g. Fedora CoreOS will "rebase" on top of this project.
